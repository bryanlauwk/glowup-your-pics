...
const PhotoLineupStationV2: React.FC<PhotoLineupStationProps> = ({
  ...
  // Category-specific enhancement suggestions - shortened for cleaner UI
  const categoryPromptSuggestions = {
    'the-hook': [
      "Golden hour lighting with sparkling eyes",
      "Professional headshot with perfect symmetry", 
      "Candid laugh with studio lighting"
    ],
    'style-confidence': [
      "Fashion magazine pose with premium outfit",
      "Urban street style with confident stance",
      "Luxury penthouse background setting"
    ],
    'social-proof': [
      "Enhanced lighting on my face as focal point",
      "Premium event atmosphere backdrop",
      "Natural group interaction perfection"
    ],
    'passion-hobbies': [
      "Dynamic action with pro sports lighting",
      "Expert skill display with dramatic background",
      "Adventure gear with cinematic effects"
    ],
    'lifestyle-adventure': [
      "Epic landscape with dramatic golden sky",
      "National Geographic quality colors",
      "Luxury resort or mountain vista background"
    ],
    'personality-closer': [
      "Warm cozy lighting with genuine connection",
      "Perfect pet photography enhancement",
      "Heartwarming scene with emotional depth"
    ]
  };
